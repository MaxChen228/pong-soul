...
class _GameSettingsSingleton:
    ...
    _fallback_settings = {
            ...
            "renderer.ball_glow.max_spin_reference": 20.0,
            "renderer.ball_glow.color_rgb": [255, 223, 186],
            "renderer.ball_glow.min_alpha": 30,
            "renderer.ball_glow.max_alpha": 150,
        }
    ...
    _key_map = {
            ...
            "VISUAL_SPIN_MULTIPLIER": "renderer.visual_spin_multiplier",
            "BALL_GLOW_ENABLE": "renderer.ball_glow.enable",
            "BALL_GLOW_MAX_RADIUS_FACTOR": "renderer.ball_glow.max_radius_factor",
            "BALL_GLOW_MAX_SPIN_REF": "renderer.ball_glow.max_spin_reference",
            "BALL_GLOW_COLOR_RGB": "renderer.ball_glow.color_rgb",
            "BALL_GLOW_MIN_ALPHA": "renderer.ball_glow.min_alpha",
            "BALL_GLOW_MAX_ALPHA": "renderer.ball_glow.max_alpha",
        }
